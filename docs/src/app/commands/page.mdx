...
`codegen status` reports active, restored, degraded, recovery-error, and cleanup-pending states. It also reports capture and omission warnings. Use `codegen discard` to remove an unfinished or damaged journal.
